...
def get_source_data_path() -> pathlib.Path:
    source_data_path = kagglehub.dataset_download("bhanupratapbiswas/weather-data")
    logger.info(f"SOURCE_DATA_PATH: {source_data_path}")
